  ...
  create  table "analytics"."public"."ranked_students_top_and_bottom_10_q2__dbt_tmp"
  
  
    as
  
  (
    ranked_students_top_and_bottom_10_q2 AS (
    SELECT
        student_id,
        avg_completion_rate,
...
FROM ranked_students_top_and_bottom_10_q2
WHERE rank_desc <= 10
UNION 
